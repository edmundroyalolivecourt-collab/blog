...
export default function Technology() {
    ...
    return (
        <div className="container mx-auto px-6 md:px-12 py-20">
            <div className="mb-16">
                <h1 className="font-serif text-5xl md:text-7xl font-bold mb-6">Technology</h1>
                <p className="text-xl text-muted-foreground max-w-2xl">
                    Exploring the tools, trends, and innovations shaping our future. From AI to sustainable tech, we cover it all.
                </p>
            </div>
